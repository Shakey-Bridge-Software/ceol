...
- [x] ~~Deleted custom tune leaves greyed-out sheet music behind~~ — fixed: `sheet-music`/`sheet-empty` divs carry distinct `:replicant/key`s (`views.cljs`), forcing a clean remount instead of Replicant reusing the abc.js-managed node.
